...
function transformRecord(record: any): Project {
  ...
  return {
    ...
    parkingGround: fields["Loading "] ? Number(fields["Parking ground"]) : null,
    parkingUnderground: fields["Height"] ? Number(fields["Parking underground"]) : null,
    ...
    description: fields["Certificate"] || "",
