...
function transformRecord(record: any): Project {
  ...
  return {
    ...
    propertyType: fields["Class"] || fields["Type"] || "B",
    address: fields["Adrese"] || "",
    city: "Riga",
    district: fields["Area"] || fields["District"] || "",
    ...
    totalArea: parseFloat(String(fields["Total Area"] || 0).replace(/\s/g, "")) || 0,
    minUnitSize: parseFloat(String(fields["Vaccancy"] || 0).replace(/\s/g, "")) || 0,
    ...
    availableArea: parseFloat(String(fields["Vaccancy"] || 0)) || 0,
    parkingGround: null,
    parkingUnderground: null,
    rentPricePerSqm: parseFloat(String(fields["Asking rent rate"] || 0)) || 0,
    floors: parseInt(fields["Floors"]) || 0,
    completionDate: fields["Construction date"] ? String(fields["Construction date"]) : "",
    description: fields["Description"] || "",
    amenities: fields["Amenities"] || [],
    expansion: fields["Expansion"] ? parseFloat(String(fields["Expansion"])) : null,
    loading: fields["Loading "] || null,
    certificate: fields["Certificate"] || null,
    ceilingHeight: fields["Height"] ? parseFloat(String(fields["Height"])) : null,
    columnGrid: fields["Column Grid"] || null,
    floorLoad: fields["Floor load"] || null,
    sprinklers: fields["Sprinklers"] || null,
